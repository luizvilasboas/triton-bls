...
class TritonClient:
    ...
    def run_inference(self, model_name: str, input_image: np.ndarray):
        inputs = [
            grpcclient.InferInput("images", input_image.shape, "FP32"),
            grpcclient.InferInput("model", [1], np_to_triton_dtype(np.object_)),
        ]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", "-m", type=str, default="yolov8n")
